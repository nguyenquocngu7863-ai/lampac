(function () {
  ...
  function installStyle() {
    ...
    style.id = styleId;
    style.textContent = [
      // Square poster must apply at EVERY viewport width. The base CSS in
      // online.js forces 13em x 8.2em (and 7em x 6em under 480px), which kept
      // the poster rectangular whenever the old max-width media query did not
      // match (landscape phones, tablets, TV boxes, scaled WebViews).
