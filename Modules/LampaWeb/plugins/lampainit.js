(function() {
  ...
  function syncPlugins() {
    ...
    if (Lampa.Storage.get(resetKey, 'false') !== 'true') {
      ...
      var lampacPluginPath = /\/(?:dlna|tracks|transcoding|tmdbproxy|cubproxy|online|online-compact|player-landscape|vietnamese|jackett|watchtogether|catalog|dorama|subsense-auto|subsense|subfinder|stremiosub|adminpanel|gst|autotracks|sisi|sisi-layout|sisi-restyle|startpage|sync|timecode|bookmark|ts|backup)\.js(?:[?#]|$)/i;
