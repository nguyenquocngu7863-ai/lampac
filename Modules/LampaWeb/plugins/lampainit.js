(function() {
  ...
  function syncPlugins() {
    ...
    var resetKey = 'lampac_plugin_reset_20260829_v3';
    if (Lampa.Storage.get(resetKey, 'false') !== 'true') {
      Lampa.Storage.set('lampac_plugins_backup_20260823', plugins);
      var lampacPluginPath = /\/(?:dlna|tracks|transcoding|tmdbproxy|cubproxy|online|online-compact|vietnamese|jackett|watchtogether|catalog|dorama|subsense-auto|subsense|subfinder|stremiosub|adminpanel|gst|sisi|sisi-layout|sisi-restyle|startpage|sync|timecode|bookmark|ts|backup)\.js(?:[?#]|$)/i;
