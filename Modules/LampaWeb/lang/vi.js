export default {
    ...
    settings_server_link: 'Sử dụng liên kết',
    settings_server_links: "Liên kết",
    settings_server_placeholder: 'Ví dụ: 192.168.X',
    settings_server_link_one: 'Liên kết chính',
    settings_server_link_one_descr: 'Nhập liên kết chính tới TorrServer',
    settings_server_link_two: 'Liên kết phụ',
    settings_server_link_two_descr: 'Nhập liên kết TorrServer phụ',
    settings_server_additionally: 'Tùy chọn bổ sung',
    settings_server_client: 'Client tích hợp',
    settings_server_client_descr: 'Dùng client TorrServer JS tích hợp; nếu tắt sẽ dùng client hệ thống.',
    settings_server_base: 'Lưu vào cơ sở dữ liệu',
    settings_server_base_descr: 'Torrent sẽ được thêm vào cơ sở dữ liệu TorrServer',
    settings_server_preload: 'Dùng bộ đệm tải trước',
    settings_server_preload_descr: 'Chờ bộ đệm TorrServer tải đủ trước khi phát',
    settings_server_auth: 'Xác thực',
    settings_server_password_use: 'Đăng nhập bằng mật khẩu',
    settings_server_login: 'Tên đăng nhập',
    settings_server_password: 'Mật khẩu',
    settings_server_not_specified: 'Chưa thiết lập',
    settings_server_search_type: 'Kiểu tìm kiếm',
    settings_server_search_type_descr: 'Chọn tìm torrent từ Rutor tích hợp, Torznab trong TorrServer hoặc cả hai.',
    ...
    settings_interface_black_style: 'Giao diện màu đen',
    ...
    speedtest_button: 'Kiểm tra tốc độ',
    ...
    settings_server_gts_descr: 'Tự động chuyển video sang định dạng tương thích khi cần.',
	settings_server_tracktimecode: 'Bật TrackTimecode',
    settings_server_tracktimecode_descr: 'Lưu tiến độ xem phim trên TorrServer; tùy chọn này cũng phải được bật trong TorrServer.',
