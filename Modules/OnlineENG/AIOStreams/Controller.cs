...
public sealed class AIOStreamsController : BaseOnlineController<ModuleConf>
{
    ...
    )
    {
        ...
        // Trả danh sách nguồn để client hiện popup chọn link trước khi phát
        // (Online/plugin.js bật Lampa.Select khi response là mảng).
        // Chỉ redirect play-luôn khi play=true.
