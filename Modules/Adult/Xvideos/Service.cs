...
public static class XvideosTo
{
    ...
    public static List<MenuItem> Menu(string host, string plugin, string sort, string c)
    {
        ...
        if (sort != "like" && (plugin == "xds" || plugin == "xdsred"))
        {
            ...
            {
                new("Tất cả", url),
                new("Asian Woman", $"{url}?sort={sort}&c=Asian_Woman-32"),
                new("Anal", $"{url}?sort={sort}&c=Anal-12"),
                new("Arab", $"{url}?sort={sort}&c=Arab-159"),
                new("Bi Sexual", $"{url}?sort={sort}&c=Bi_Sexual-62"),
                new("Blonde", $"{url}?sort={sort}&c=Blonde-20"),
                new("Big Ass", $"{url}?sort={sort}&c=Big_Ass-24"),
                new("Big Tits", $"{url}?sort={sort}&c=Big_Tits-23"),
                new("Big Cock", $"{url}?sort={sort}&c=Big_Cock-34"),
                new("Brunette", $"{url}?sort={sort}&c=Brunette-25"),
                new("Oiled", $"{url}?sort={sort}&c=Oiled-22"),
                new("Cam Porn", $"{url}?sort={sort}&c=Cam_Porn-58"),
                new("Gangbang", $"{url}?sort={sort}&c=Gangbang-69"),
                new("Gapes", $"{url}?sort={sort}&c=Gapes-167"),
                new("Mature", $"{url}?sort={sort}&c=Mature-38"),
                new("Indian", $"{url}?sort={sort}&c=Indian-89"),
                new("Fucked Up Family", $"{url}?sort={sort}&c=Fucked_Up_Family-81"),
                new("Creampie", $"{url}?sort={sort}&c=Creampie-40"),
                new("Cuckold", $"{url}?sort={sort}&c=Cuckold-237"),
                new("Latina", $"{url}?sort={sort}&c=Latina-16"),
                new("Lesbian", $"{url}?sort={sort}&c=Lesbian-26"),
                new("Amateur", $"{url}?sort={sort}&c=Amateur-65"),
                new("MILF", $"{url}?sort={sort}&c=Milf-19"),
                new("Interracial", $"{url}?sort={sort}&c=Interracial-27"),
                new("Blowjob", $"{url}?sort={sort}&c=Blowjob-15"),
                new("Lingerie", $"{url}?sort={sort}&c=Lingerie-83"),
                new("Ass", $"{url}?sort={sort}&c=Ass-14"),
                new("Redhead", $"{url}?sort={sort}&c=Redhead-31"),
                new("Squirting", $"{url}?sort={sort}&c=Squirting-56"),
                new("Solo And Masturbation", $"{url}?sort={sort}&c=Solo_and_Masturbation-33"),
                new("Cumshot", $"{url}?sort={sort}&c=Cumshot-18"),
                new("Teen", $"{url}?sort={sort}&c=Teen-13"),
                new("Femdom", $"{url}?sort={sort}&c=Femdom-235"),
                new("Fisting", $"{url}?sort={sort}&c=Fisting-165"),
                new("BBW", $"{url}?sort={sort}&c=bbw-51"),
                new("Black Woman", $"{url}?sort={sort}&c=Black_Woman-30"),
                new("Stockings", $"{url}?sort={sort}&c=Stockings-28"),
