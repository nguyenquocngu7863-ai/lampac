(function () {
  ...
  function installStyle() {
    ...
    style.id = styleId;
    style.textContent = [
      // Compact layout + square 1:1 poster, PORTRAIT ONLY. In landscape the
      // stock online.js layout is kept untouched. Inside portrait the rules
      // apply at every width (previously they lived only under a
      // max-width media query, so many WebView/viewport combos fell through
      // to the stock 13em x 8.2em rectangle).
      ...
      '  body.lampac-online-compact .online-prestige--full .online-prestige__img { width: 5.8em !important; height: 5.8em !important; min-width: 5.8em !important; max-width: 5.8em !important; min-height: 5.8em !important; max-height: 5.8em !important; }',
